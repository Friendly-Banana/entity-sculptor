            ...
            final LiteralCommandNode<ServerCommandSource> match = dispatcher.register(literal("entitysculptor match").then(CommandManager.argument("r", DoubleArgumentType.doubleArg(0, 255))
                .then(CommandManager.argument("g", DoubleArgumentType.doubleArg(0, 255))
                    .then(CommandManager.argument("b", DoubleArgumentType.doubleArg(0, 255))
                        .executes(context -> execute(context.getSource(), new ColorMatcher.RGBA(DoubleArgumentType.getDouble(context, "r"), DoubleArgumentType.getDouble(context, "g"), DoubleArgumentType.getDouble(context, "b"), DEFAULT_ALPHA), DirectionsArgumentType.DIRECTIONS, EntitySculptorClient.CONFIG.amountOfSuggestions()))
                        .then(CommandManager.argument("a", DoubleArgumentType.doubleArg(0, 255))
                            .executes(context -> execute(context.getSource(), new ColorMatcher.RGBA(DoubleArgumentType.getDouble(context, "r"), DoubleArgumentType.getDouble(context, "g"), DoubleArgumentType.getDouble(context, "b"), DoubleArgumentType.getDouble(context, "a")), DirectionsArgumentType.DIRECTIONS, EntitySculptorClient.CONFIG.amountOfSuggestions()))
                            .then(CommandManager.argument("directions", DirectionsArgumentType.directions())
                                .executes(context -> execute(context.getSource(), new ColorMatcher.RGBA(DoubleArgumentType.getDouble(context, "r"), DoubleArgumentType.getDouble(context, "g"), DoubleArgumentType.getDouble(context, "b"), DoubleArgumentType.getDouble(context, "a")), DirectionsArgumentType.getDirections(context, "directions"), EntitySculptorClient.CONFIG.amountOfSuggestions()))
                        ...
                        .then(CommandManager.argument("directions", DirectionsArgumentType.directions())
                            .executes(context -> execute(context.getSource(), new ColorMatcher.RGBA(DoubleArgumentType.getDouble(context, "r"), DoubleArgumentType.getDouble(context, "g"), DoubleArgumentType.getDouble(context, "b"), DEFAULT_ALPHA), DirectionsArgumentType.getDirections(context, "directions"), EntitySculptorClient.CONFIG.amountOfSuggestions()))
                            .then(CommandManager.argument("limit", IntegerArgumentType.integer())
